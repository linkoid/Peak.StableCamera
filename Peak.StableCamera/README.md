...
- **Tracking Power**
	...
	- Default: 2.0
- **Hide Full Body**
	- Hide the entire body. Will cause arms to be invisible in first person, but when TrackingPower is less than 1, this will prevent the body from blocking the view.
	- Default: False
